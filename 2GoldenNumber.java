...
public class GoldenNumber {
    ...
    public static void main(String[] args) {
      ...
      int goldenNumber2=(int)(Math.random()*10);
         System.out.println("you already have two chance \n if you write both numbers correct you will win 10_000$ \n "
                 + "if write in a wrong order you will win 3_000$ \n if you are wrong in one of the numbers you will win 1_000$");
        ...
        }else if (guess1==goldenNumber1 ^ guess2==goldenNumber2){
